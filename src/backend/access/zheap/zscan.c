...
zheapgetpage(TableScanDesc sscan, BlockNumber page)
{
	...
	/*
	 * Prune and repair fragmentation for the whole page, if possible. Fixme -
	 * Pruning is required in zheap for deletes, so we need to make it work.
	 */
					...
					Snapshot snapshot, bool *all_dead)
{
	...
	{
		/*
		 * For deleted item pointers, we've already set the value for
		 * all_dead.
		 */
		return NULL;
	}
